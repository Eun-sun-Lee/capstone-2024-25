...
import capstone.allbom_gateway.exception.BadRequestException;
import capstone.allbom_gateway.exception.ExpiredPeriodJwtException;
...
public class TokenProcessor {
    ...
    public TokenProcessor(
            ...
            @Value("${jwt.access-expiration-time}") final int tokenExpirationTime,
            @Value("${jwt.refresh-expiration-time}") final int refreshTokenExpirationTime,
